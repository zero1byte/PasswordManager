...
// P1: all keys >= 20 and < 40

// P2: all keys >= 40 and < 60

// P3: all keys >= 60

//p1 may be a data page or an index page, if it is a data page it will have records and if it is an index page it will have keys and children